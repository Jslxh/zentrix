  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <motion.div 
        ...
        className="flex flex-col flex-shrink-0 h-full border-r border-border bg-panel/75 backdrop-blur-md text-muted select-none"
      >
        {/* Sidebar Header */}
      ...
      <div className="flex flex-col flex-1 h-full overflow-hidden">
        {/* Top Header */}
        <header className="flex items-center justify-between h-16 px-6 border-b border-border bg-panel/75 backdrop-blur-md z-10">
          <div className="flex items-center gap-3">
            <h1 className="font-poppins font-semibold text-lg text-text tracking-wide">
              {navItems.find(item => item.path === location.pathname)?.name || 'Platform'}
            </h1>
            <span className="text-xs text-muted">/</span>
            <span className="text-xs text-muted uppercase tracking-wider font-semibold font-poppins">
              Zentrix Safety Node
            </span>
          </div>
